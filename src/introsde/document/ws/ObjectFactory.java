...
public class ObjectFactory {
    ...
    private final static QName _Login_QNAME = new QName("http://ws.document.introsde/", "login");
    ...
    private final static QName _LoginResponse_QNAME = new QName("http://ws.document.introsde/", "loginResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.document.introsde/", name = "login")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.document.introsde/", name = "loginResponse")
